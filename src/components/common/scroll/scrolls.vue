    ...
    >
      <div ref="pulldown" class="pulldown-wrapper" :style="pullDownStyle" v-if="pullDownRefresh">
        <div class="before-trigger" v-if="beforePullDown">
          <!--<bubble :y="bubbleY" v-if="false"></bubble>-->
          <div><span>{{releaseRefreshTxt}}</span></div>
        </div>
        <div class="after-trigger" v-else>
...
<script type="text/ecmascript-6">
  ...
  import Loading from '../loading/loadings.vue'
  /*import Bubble from '../bubble/bubble.vue'*/
  import { getRect } from '../../../public/dom'
  ...
  export default {
    ...
    computed: {
      ...
      releaseRefreshTxt(){
        return (this.pullDownRefresh && this.pullDownRefresh.textRe) || ''
      }
    },
    created() {
